...
define(["jquery", "core/ajax", "core/notification"], ($, ajax, notification) => ({
  init: (config) => {
    ...
    var ctx = canvas.getContext("2d"),
      ...
      docviewerid = config.docviewerid,
        ...
        var promises = ajax.call([
          {
            ...
            args: { contextid: contextid, docviewerid: docviewerid, content: fullText.substring(0, 10000) },
          },
        ])
        promises[0]
          .done((response) => {
